# Scrapy settings for crawl_engine

BOT_NAME = "crawl_engine"

SPIDER_MODULES = ["crawl_engine.spiders"]
NEWSPIDER_MODULE = "crawl_engine.spiders"
...
# ==============================================================================
ITEM_PIPELINES = {
    "crawl_engine.pipelines.CrawlEnginePipeline": 300,
    "crawl_engine.pipelines.JsonFilePipeline": 400,
}
...
DOWNLOADER_MIDDLEWARES = {
    'crawl_engine.middlewares.PlaywrightStealthMiddleware': 585,
}
